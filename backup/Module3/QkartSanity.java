...
public class QkartSanity {
    ...
    public static void takeScreenshot(WebDriver driver, String screenshotType, String description) {
        ...
        FileUtils.copyFile(screenshot, destination);
            ...
            System.out.println("Unable to take the screen shot");
        }
    }   
    ...
    public static Boolean TestCase03(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (searchResults.size() == 0) {
            ...
            takeScreenshot(driver, "Failed_NoResult", "TestCase03");
            return false;
        }
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (!elementText.toUpperCase().contains("YONEX")) {
                logStatus("TestCase 3", "Test Case Failure. Test Results contains un-expected values: " + elementText,
                        "FAIL");
                        takeScreenshot(driver, "Failed_Unexpected", "TestCase03");
                return false;
            }
        }
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (result.verifySizeChartExists()) {
                ...
                if (result.openSizechart()) {
                    ...
                    takeScreenshot(driver, "FailedOpenSize", "TestCase04");
                    return false;
                }

            } else {
                logStatus("TestCase 4", "Test Case Fail. Size Chart Link does not exist", "FAIL");
                takeScreenshot(driver, "SizeChartLink", "TestCase04");
                return false;
            }
        }
    ...
    public static Boolean TestCase06(RemoteWebDriver driver) throws InterruptedException {
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
            takeScreenshot(driver, "Fail TestCase", "TestCase05");
            logStatus("End TestCase", "Test Case 5: Happy Flow Test Failed : ", status ? "PASS" : "FAIL");
        }
        homePage.navigateToHome();
    ...
    public static Boolean TestCase08(RemoteWebDriver driver) throws InterruptedException {
        ...
        homePage.navigateToHome();
        List<String> expectedCartContents = new ArrayList<>();
        ...
        logStatus("End Test case", "Test Case 8 : MultiTab Scenario", status ? "PASS":"FAIL");
    ...
    public static Boolean TestCase09(RemoteWebDriver driver) throws InterruptedException {
        ...
        Home homePage = new Home(driver);
        homePage.navigateToHome();
        // Identify the webelement Privacy policy
        WebElement privacyPolicyBtn = driver.findElement(By.xpath("//a[@href='privacy-policy']"));
        privacyPolicyBtn.click();
        // wait till the page loads
        WebDriverWait webDriverWait = new WebDriverWait(driver,2);
        webDriverWait.until(ExpectedConditions.numberOfWindowsToBe(2));
        // Check the URL has not changed
        status = driver.getCurrentUrl().equals("https://crio-qkart-frontend-qa.vercel.app/");
        logStatus("Test Step", "Test Case 9 : Home Page URL is not changed", status ? "PASS":"FAIL");
        // Navigate to the new tab 
        Set<String> windowSet = driver.getWindowHandles();
        List<String> windowList = new ArrayList<>(windowSet);
        driver.switchTo().window(windowList.get(1));
        String  headerText = driver.findElement(By.xpath("//h2")).getText();
        status = headerText.equalsIgnoreCase("Privacy Policy");
        logStatus("Test Step", "Test Case 9 : Privacy Policy Verified", status ? "PASS":"FAIL");
        // Navigate back to home page 
        driver.switchTo().window(windowList.get(0));
        // Identify the webelement Terms of Service 
        WebElement termsOfServiceBtn = driver.findElement(By.xpath("//a[text()='Terms of Service']"));
        ...
        // Verify TermsOfService
        headerText = driver.findElement(By.xpath("//h2")).getText();
        status = headerText.equalsIgnoreCase("Terms of Service");
        logStatus("Test Step", "Test Case 9 : Terms Of Service verified", status ? "PASS":"FAIL");
        // Navigate back to home page 
        driver.switchTo().window(windowList.get(0));
        // Click on about US
        ...
        webDriverWait.until(ExpectedConditions.numberOfWindowsToBe(4));
        status = driver.getCurrentUrl().equals("https://crio-qkart-frontend-qa.vercel.app/");
        logStatus("Test Step", "Test Case 9 : Home Page URL is not changed", status ? "PASS":"FAIL");
        ...
        // Verify TermsOfService
        headerText = driver.findElement(By.xpath("//h2")).getText();
        status = headerText.equalsIgnoreCase("About Us");
        logStatus("Test Step", "Test Case 9 : About US Verified", status ? "PASS":"FAIL");
        driver.close();
        ...
        logStatus("End Test case", "Test Case 9 : All Conditions verified in the footer", status ? "PASS":"FAIL");
    ...
    public static Boolean TestCase10(RemoteWebDriver driver) throws InterruptedException {
        ...
        webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@class='card-block']")));
        ...
        status = webDriverWait.until(ExpectedConditions.invisibilityOf(contactNowBtn));

        logStatus("End Test case", "Test Case 10:Contact Us Verified", status ? "PASS":"FAIL");
    ...
    public static Boolean TestCase11(RemoteWebDriver driver) throws InterruptedException {
        ...
        status = registration.registerUser("testUser", "abc@123", true);
        if (!status) {
            logStatus("TestCase 11", "Test Case Failure.", "FAIL");
            takeScreenshot(driver, "Failed Check Advertisement", "TestCase11");
        }
        ...
        if (!status) {
            logStatus("Step Failure", "User Perform Login Failed", status ? "PASS" : "FAIL");
            logStatus("End TestCase", "Test Case 11: Failed Check Advertisement : ", status ? "PASS" : "FAIL");
        }
       ...
       WebDriverWait  webDriverWait = new WebDriverWait(driver,5);
        ...
        logStatus("Test Step", "Test case 11 : Advertisements displaying: ", status ? "PASS":"FAIL");
        ...
        for (int i=0;i<=1;i++) {
            ...
            logStatus("Test Step", "Test case 11 : Redirected to Checkout Page :  ", status ? "PASS":"FAIL");
            driver.navigate().back();
            driver.switchTo().parentFrame();
        }
        logStatus("End Test case", "Test Case 11:Check for advertisements : ", status ? "PASS":"FAIL");
